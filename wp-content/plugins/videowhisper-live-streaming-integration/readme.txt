...
Tags: video, live, BuddyPress, broadcast, stream, tv, widget, plugin, media, livestream, channel, sidebar, webcam, cam, twitch, hitbox, justin, ustream, stickam, iOS, wirecast, iPhone, iPad, script, clone, alternative, turnkey, myCRED, webrtc
...
== Description ==
This plugin enables site users to broadcast live streaming channels from various sources (*PC webcam, IP cameras, video playlists, mobile and desktop encoder apps*).

Live channels can be displayed on website pages in web player with chat, tips or plain *HTML5* HLS / MPEG DASH live video streaming for mobile. Solution manages unlimited channels, membership types.
...
* 24/7 IP camera support (restream rtsp, rtmp, rtmps, udp streams)
...
* tips to broadcaster with myCRED
...
http://broadcastlivevideo.com/setup-tutorial/
* See application and edition instructions on plugin homepage:
https://videowhisper.com/?p=WordPress+Live+Streaming
...
https://videowhisper.com/?p=RTMP+Applications
...
7. Channel management page (with channel features)
